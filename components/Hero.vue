    ...
    <section class="text-gray-600 body-font">
        <div class="container mx-auto flex px-10 py-5 md:flex-row flex-col items-center">
            <div
                ...
                <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Welcome to our Website!</h1>
                <p class="mb-8 leading-relaxed">Here you get whatever you want just type here... or navigate to.</p>
                <div class="flex w-full md:justify-start justify-center items-end">
                    <div class="relative mr-4 md:w-full lg:w-full xl:w-1/2 w-2/4">
                        <!-- <label for="hero-field" class="leading-7 text-sm text-gray-600">Search</label> -->
                ...
                <p class="text-sm mt-2 text-gray-500 mb-8 w-full ">Wheels, engine, parts</p>
